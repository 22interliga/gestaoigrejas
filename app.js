...
document.getElementById('btn-setup').addEventListener('click', async () => {
  ...
  try {
    ...
    // onAuthStateChanged cuida do redirecionamento para o app
  } catch (err) {
...
async function carregarEstatisticas(igrejaId) {
  try {
    ...
    document.getElementById('stat-lideres').textContent = lideres;
  } catch (err) {
...
function configurarNavegacao(usuario) {
  ...
  const rotaLabels = {
    filiais: 'Filiais', tesouraria: 'Tesouraria',
    inventario: 'Inventário', comunicacao: 'Comunicação', diretoria: 'Diretoria',
